...
export default function AboutSusan() {
  ...
  return (
    <section className="container mx-auto px-6 max-w-7xl pt-16 pb-8 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        ...
        <div className="md:col-span-7 flex flex-col gap-5 text-foreground/80 leading-relaxed">
          ...
          <button
            ...
            className="mt-4 bg-[#78A179] hover:bg-[#688a68] text-white px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 w-fit self-start"
          >
            {expanded ? "Lees minder" : "Lees verder"}
          </button>
        </div>
      </div>
    </section>
